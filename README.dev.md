...
git clone git@github.com:NMannall/baklava .
...
Don't forget to also make a [release on GitHub](https://github.com/NMannall/baklava/releases/new).GitHub-Zenodo integration will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.